	...
	public function index() {  
		...
		foreach ($geo_zones as $geo_zone) {
			if (isset($this->request->post['jne_' . $geo_zone['geo_zone_id'] . '_rate'])) {
				$this->data['jne_' . $geo_zone['geo_zone_id'] . '_rate'] = $this->request->post['jne_' . $geo_zone['geo_zone_id'] . '_rate'];
			} else {
				$this->data['jne_' . $geo_zone['geo_zone_id'] . '_rate'] = $this->config->get('jne_' . $geo_zone['geo_zone_id'] . '_rate');
			}		
			
			if (isset($this->request->post['jne_' . $geo_zone['geo_zone_id'] . '_status'])) {
				$this->data['jne_' . $geo_zone['geo_zone_id'] . '_status'] = $this->request->post['jne_' . $geo_zone['geo_zone_id'] . '_status'];
			} else {
				$this->data['jne_' . $geo_zone['geo_zone_id'] . '_status'] = $this->config->get('jne_' . $geo_zone['geo_zone_id'] . '_status');
			}		
		}
		...
		if (isset($this->request->post['jne_tax_class_id'])) {
			$this->data['jne_tax_class_id'] = $this->request->post['jne_tax_class_id'];
		} else {
			$this->data['jne_tax_class_id'] = $this->config->get('jne_tax_class_id');
		}
		
		if (isset($this->request->post['jne_status'])) {
			$this->data['jne_status'] = $this->request->post['jne_status'];
		} else {
		...
		if (isset($this->request->post['jne_sort_order'])) {
			...
			$this->data['jne_sort_order'] = $this->config->get('jne_sort_order');
		}	
